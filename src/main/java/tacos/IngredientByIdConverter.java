...
// Converter to convert String ingredient to Ingredient object
@Component
public class IngredientByIdConverter implements Converter<String, Ingredient> {
  
  // Map to hold ingredient ID to Ingredient object mappings
  private Map<String, Ingredient> ingredientMap = new HashMap<>();
  
  // Constructor to initialize the ingredient map with predefined ingredients
  ...
  // Converts the given ingredient ID string to the corresponding Ingredient object
  @Override
